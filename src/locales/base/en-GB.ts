...
export default {
  ...
  error: {
    ...
    [GucchoError.RelationNotFound]: 'Relation not found.',
    ...
    [GucchoError.InvalidId]: 'Invalid ID',
    [GucchoError.BeatmapNotFound]: 'Beatmap not found.',
    [GucchoError.EmptyPassword]: 'Password cannot be empty.',
    [GucchoError.ProhibitedRelationWithSelf]: 'You cannot have relation with yourself.',
